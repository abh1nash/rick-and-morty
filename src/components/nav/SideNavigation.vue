<template>
  ...
  >
    <div class="w-1/3">
      <button
        class="bg-blue-400 hover:bg-blue-500 text-bold text-white px-4 py-2 rounded"
    ...
    <div class="w-1/3 text-right">
      <button
        class="ml-auto bg-blue-400 hover:bg-blue-500 text-bold text-white px-4 py-2 rounded"
